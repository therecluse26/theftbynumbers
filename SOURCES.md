...
### Waste, fraud and abuse, added 2026-08-27

| Claim | Figure | Link | Verified | Note |
| --- | --- | --- | --- | --- |
| Year-end spending spree | 4.9× | [Liebman and Mahoney, American Economic Review, 2017](https://www.aeaweb.org/articles?id=10.1257/aer.20131296) | `yes` | Spending in the last week of the fiscal year runs 4.9× the rest-of-year weekly average. Year-end IT projects were 2.2 to 5.6 times more likely to score below the middle. |
| Duplicate programmes still uncut | $100bn+ | [GAO, 2025 duplication and cost savings report](https://www.gao.gov/press-release/gao-recommendations-led-725-billion-financial-benefits-new-duplication-cost-savings-report-shows-potential-100-billion) | `yes` | One page states both figures: $725bn already saved, $100bn+ still on the table. |
| Fraud against the government | $233bn a year | [GAO-24-105833](https://www.gao.gov/products/gao-24-105833) | `yes` | GAO's first government-wide estimate: $233bn to $521bn a year, 3% to 7% of federal spending. The card uses the low end. |
| Fraudulent pandemic business loans | $200bn | [SBA OIG 23-09](https://www.sba.gov/document/report-23-09-covid-19-pandemic-eidl-ppp-loan-fraud-landscape) | `yes` | "Over $200 billion", at least 17% of COVID EIDL and PPP disbursements. About $30bn seized or returned. |
| Pentagon audits failed | 8 of 8 | [CRS IF12627](https://www.congress.gov/crs-product/IF12627) | `yes` | Eighth disclaimer of opinion, FY2025, $4.65tn of assets, 26 material weaknesses. congress.gov answers a browser and refuses the link checker. |
| Afghanistan reconstruction wasted | $26bn | [SIGAR Final Report, December 2025 (archived)](https://web.archive.org/web/20260121091143/https://www.sigar.mil/Portals/147/Files/Reports/sigar-final-report.pdf) | `yes` | 1,327 instances, at least $26bn lost of $148.21bn appropriated. |
| Equipment left to the Taliban | $7.1bn | [SIGAR Final Report, December 2025 (archived)](https://web.archive.org/web/20260121091143/https://www.sigar.mil/Portals/147/Files/Reports/sigar-final-report.pdf) | `yes` | Same report. SIGAR says it now forms the core of the Taliban security apparatus. |
| Boeing soap dispenser markup | 7,943% | [DODIG-2025-009](https://media.defense.gov/2024/Nov/06/2003579070/-1/-1/1/DODIG-2025-009%20SECURE.PDF) | `yes` | 46 C-17 spare parts checked, 12 overpriced, $149,072 overpaid on the dispenser alone. |
| Afghan filling station | $42.7m | [SIGAR-16-2-SP (archived)](https://web.archive.org/web/20211031085901/https://www.sigar.mil/pdf/special%20projects/SIGAR-16-2-SP.pdf) | `yes` | $42,718,730 spent 2011–2014. A comparable station in Pakistan costs no more than $500,000. |
| G222 aircraft sold as scrap | $40,257 | [SIGAR 21-21-SP](https://apps.dtic.mil/sti/pdfs/AD1149071.pdf) | `unverified` | About $549m spent, 16 aircraft scrapped at about six cents a pound. DTIC serves the report and refuses the link checker. |
| One SLS launch | $4.1bn | [NASA OIG testimony, CT-2022-01](https://oig.nasa.gov/wp-content/uploads/2024/02/CT-2022-01.pdf) | `yes` | The inspector general's own word to Congress was "unsustainable". |
| F-35 programme, whole life | $2tn | [GAO, The F-35 Will Now Exceed $2 Trillion](https://www.gao.gov/blog/f-35-will-now-exceed-2-trillion-military-plans-fly-it-less) | `yes` | $442bn acquisition, about $1.6tn sustainment, flying to 2088. |
| Civilians killed by US airstrikes | 3 to 7 a day | [Airwars, twenty-year assessment](https://airwars.org/tens-of-thousands-of-civilians-likely-killed-by-us-in-forever-wars/) | `derived` | Airwars puts the toll at 22,679 to 48,308 civilians, 2001 to 2021, across seven countries. Divided by the 7,305 days of those twenty years that is 3.1 to 6.6 a day. The card rounds to "3 to 7". |

**SIGAR no longer exists.** It closed on 31 January 2026 and `sigar.mil` no longer
resolves. Its reports are cited from the Internet Archive, or from DTIC, which
holds its own copies. Do not "fix" these links back to `sigar.mil`.
